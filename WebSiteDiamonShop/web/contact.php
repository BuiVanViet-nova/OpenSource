                ...
                <div class="span8 relative">
                    ...
                    <div class="absoluteBlk">
                        <div class="well wellsmall">
                            ...
                            <h5>
                                Tầng 3, Số 40/17 Đoàn Trần Nghiệp, <br />
                                TP. Nha Trang, Khánh Hòa<br /><br />

                                info@mysite.com<br />
                                ﻿Tel 123-456-6780<br />
                                Fax 123-456-5679<br />
                                web:wwwmysitedomain.vanviet.com
                            </h5>
                        </div>
                    </div>
                </div>
                    ...
                    <form class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <input type="text" placeholder="title" class="input-xlarge" />

                            </div>
                            <div class="control-group">
                                <textarea rows="3" id="textarea" class="input-xlarge" value="Nội dung liên hệ"></textarea>
