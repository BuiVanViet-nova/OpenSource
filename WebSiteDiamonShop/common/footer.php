...
<section class="our_client">
	...
	<div class="row">
		<div class="span2">
			<a href="#"><img alt=""
				src="../template/assets/user/img/1.png'/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="../template/assets/user/img/2.png'/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="../template/assets/user/img/3.png'/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="../template/assets/user/img/4.png'/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="../template/assets/user/img/5.png'/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="../template/assets/user/img/6.png'/>"></a>
		</div>
	</div>
</section>
